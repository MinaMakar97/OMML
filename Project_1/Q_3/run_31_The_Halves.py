...
outer_iterations, y_train_pred, end, W, V, loss_train, total_nfev, total_njev, total_nit, last_message, optimizer, diff_omega = train(
...
print("Sigma=", 1)
print("rho=", rho)
print("Optimization with Least-Squares solution for V, and with solver BFGS for W")
